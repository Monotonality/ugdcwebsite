jQuery(document).ready( function($) {
	...
	$( '#toggle-sidebar a' ).attr( 'tabindex', '-1');
	$( '#toggle-sidebar button' ).attr( 'tabindex', '-1');
	...
	$( '#menu-toggle' ).click( function( e ) {
		...
		$( '#toggle-sidebar a' ).attr( 'tabindex', $( '#toggle-sidebar a' ).attr( 'tabindex' ) == '0' ? '-1' : '0' );
		$( '#toggle-sidebar button' ).attr( 'tabindex', $( '#toggle-sidebar button' ).attr( 'tabindex' ) == '0' ? '-1' : '0' );


		$('a[aria-current="page"]').attr("tabindex", "-1");
	} );

	$( '#menu-close, #menu-close-bottom' ).click( function( e ) {
		e.preventDefault();
		...
		$( '#toggle-sidebar a' ).attr( 'tabindex', $( '#toggle-sidebar a' ).attr( 'tabindex' ) == '-1' ? '0' : '-1' );
		$( '#toggle-sidebar button' ).attr( 'tabindex', $( '#toggle-sidebar button' ).attr( 'tabindex' ) == '-1' ? '0' : '-1' );
